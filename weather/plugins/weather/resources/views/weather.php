      ...
      <div id="card" class="weater">
        <div class="city-selected">
          <article>
            ...
            <div class="info">
              <div class="city"><span>miasto:</span> <?= $data['city']['name'] ?></div>
              <div class="night"><?= $data['today']['date'] ?> | TERAZ</div>

              <div class="temp"><?= $data['today']['temperature'] ?>°</div>
              ...
              <div class="wind">
                <svg version="1.1" id="wind" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 300.492 300.492" style="enable-background:new 0 0 300.492 300.492;" xml:space="preserve">
									...
									<span><?= $data['today']['wind'] ?> km/h</span>
								</div>
							</div>
                        <?php if($data['today']['time'] > '18:00:00'){
                        ?>
                        <div class="icon">
                            <img src="plugins/weather/resources/img/moon.svg" />
                        </div>
                        ...
                        ?>
                        <div class="icon">
                            <img src="plugins/weather/resources/img/sun.svg" />
                        </div>
